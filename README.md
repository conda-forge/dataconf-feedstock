...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dataconf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14485&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dataconf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dataconf` can be installed with:

```
conda install dataconf
```

It is possible to list all of the versions of `dataconf` available on your platform with:
